...
<c:forEach items="${list}" var="u">
	<div style="width:20%;min-width:300px;align-items:right;background:black;border-top-left-radius:50px;border-top-right-radius: 50px">
		<button class="normalbtn" onclick="document.getElementById('editIsPresent').value='${u.getRegistrantIsPresent()}';
											...
											document.getElementById('editParticipant').value='${u.getRegistrantName()}';
											document.getElementById('id05').style.display='block'" style="border-top-left-radius:50px;border-top-right-radius: 50px">Update Attendance</button>
	</div>
	<div class="centeredDiv" style="background:black;border:2px;border-color:white;border-bottom-left-radius:50px;border-bottom-right-radius: 50px;border-top-right-radius: 50px">
		<div style="width:flex;align-items:center"><h2 style="color:white;align-self:center;">${u.getRegistrantEventName()}</h2></div>
		<div style="width:flex;">
			<div class="centeredDiv" style="background:#FED250;border-top-left-radius:50px;border-top-right-radius:50px;">
  				<h2 style="color:black">Participant Name</h2>
  				<p style="color:black">${u.getRegistrantName()}</p>
			</div>

			<div class="centeredDiv" style="background:#F3B701;border-bottom-left-radius:50px;border-bottom-right-radius:50px;">
		  		<h2 style="color:black">Participation Status: ${u.getRegistrantIsPresent()}</h2>
			</div>
		</div>
	</div>
</c:forEach>
