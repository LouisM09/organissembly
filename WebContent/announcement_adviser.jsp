...
<div id="id05" class="modal">
  <form class="modal-content animate" action="${pageContext.request.contextPath}/update_announcement" method="post">
    ...
    <div class="container">
	  ...
	  <br><br><label for="editIsApproved"><b>Announcement Is Approved: </b></label>
	  <br><select name="editIsApproved" id="editIsApproved" style="width:50px" required>
		<option value="Yes">Yes</option>
		<option value="No">No</option>
	  </select>
	  
	  <br><br><label for="editIsEnabled"><b>Announcement Is Enabled: </b></label>
...
<c:forEach items="${list}" var="u">
	<div style="width:20%;min-width:300px;align-items:right;background:black;border-top-left-radius:50px;border-top-right-radius: 50px">
		<button class="normalbtn" onclick="document.getElementById('editIsApproved').value='${u.getAnnouncementIsApproved()}';
											...
											document.getElementById('id05').style.display='block'" style="border-top-left-radius:50px;border-top-right-radius: 50px">Edit Announcement</button>
	</div>
	<div class="centeredDiv" style="background:black;border:2px;border-color:white;border-bottom-left-radius:50px;border-bottom-right-radius: 50px;border-top-right-radius: 50px">
		...
		<div style="width:flex;">
			...
			<div class="centeredDiv" style="background:#FEC825">
  				<h2 style="color:black">Approved Status: ${u.getAnnouncementIsApproved()}</h2>
			</div>

			<div class="centeredDiv" style="background:#F3B701;border-bottom-left-radius:50px;border-bottom-right-radius:50px;">
		  		<h2 style="color:black">Enabled Status: ${u.getAnnouncementIsEnabled()}</h2>
			</div>
		</div>
	</div>
</c:forEach>
