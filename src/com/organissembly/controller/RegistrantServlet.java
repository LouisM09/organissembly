...
public class RegistrantServlet extends HttpServlet {
...
//			rd.forward(request, response);
			...
			//RequestDispatcher rd=request.getRequestDispatcher("registrant_coordinator.jsp");
			//rd.forward(request, response);
		}
...
//			RequestDispatcher rd=request.getRequestDispatcher("registrant_adviser.jsp");
//			rd.forward(request, response);
		}
		else {
