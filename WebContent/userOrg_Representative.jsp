...
<div id="id05" class="modal">
  <form class="modal-content animate" action="${pageContext.request.contextPath}/UpdateUserOrg" method="post" enctype="multipart/form-data">
    <div class="imgcontainer">
    ...
    <div class="container">
      ...
      <textarea rows=4 cols=35 placeholder="Enter About Organization" name="editOrgAbout" id="editOrgAbout" required></textarea>
      
      <label for="editOrgVision"><b>Organization Vision</b></label>
      <textarea rows=4 cols=35 placeholder="Enter Organization Vision" name="editOrgVision" id="editOrgVision" required></textarea>
      
      <label for="editOrgMission"><b>Organization Mission</b></label>
      <textarea rows=4 cols=35 placeholder="Enter Organization Mission" name="editOrgMission" id="editOrgMission" required></textarea>
...
<div class="topnav" id="myTopnav">
 ...
 <a href="${pageContext.request.contextPath}/userOrg" class="active">Organization</a>
