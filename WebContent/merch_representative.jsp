...
<div id="id05" class="modal">
  <form class="modal-content animate" action="${pageContext.request.contextPath}/add_merch" method="post" enctype="multipart/form-data">
    <div class="imgcontainer">
    ...
    <div class="container">
      <label for="merchName"><b>Merch Name</b></label>
      <input type="text" placeholder="Enter Merch Name" name="merchName" required>

      <label for="merchDescription"><b>Merch Description</b></label>
      <textarea rows=4 cols=40 placeholder="Enter details about Merch" name="merchDescription" id="merchDescription" required></textarea>
      
	  <label for="merchImage"><b>Merch Image</b></label>
      <input type="file" name="merchImage" id="merchImage" onchange="document.getElementById('output').src = window.URL.createObjectURL(this.files[0])">
	  <div class="imgcontainer">
		<img id="output" name="output" src="#" alt="Merch Image coming soon" class="leftImage" width="280px" height="280px">
      </div>

	  <br><label for="merchPrice"><b>Merch Price</b></label>
      <input type="text" placeholder="Enter Merch Price" name="merchPrice" required>
      
      <br><label for="merchPostedBy"><b>Merch Posted By: </b></label>
      <select name="merchPostedBy" id="merchPostedBy" style="width:200px" required>
      ...
      <input type="hidden" name="dateCreated" id="dateC"/>
      <br><button type="submit" onclick="setValues()">Add Merch</button>
...
<div class="centeredDiv"><button onclick="document.getElementById('id05').style.display='block'" style="font-size:30px">Add New Merch</button></div>
