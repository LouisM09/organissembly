...
<div id="id05" class="modal">
  <form class="modal-content animate" action="${pageContext.request.contextPath}/update_event" method="post" enctype="multipart/form-data">
    ...
    <div class="container">
	  ...
	  <br><br><label for="editIsApproved"><b>Event Is Approved: </b></label>
	  <br><select name="editIsApproved" id="editIsApproved" style="width:50px" required>
		<option value="Yes">Yes</option>
		<option value="No">No</option>
	  </select>
	  
	  <br><br><label for="editIsEnabled"><b>Event Is Enabled: </b></label>
	  <br><select name="editIsEnabled" id="editIsEnabled" style="width:50px" required>
		<option value="Yes">Yes</option>
		<option value="No">No</option>
	  </select>
...
<c:forEach items="${list}" var="u">
	<div style="width:20%;min-width:300px;align-items:right;background:black;border-top-left-radius:50px;border-top-right-radius: 50px">
		<button class="normalbtn" onclick="document.getElementById('editIsApproved').value='${u.getEventIsApproved()}';
											...
											document.getElementById('id05').style.display='block'" style="border-top-left-radius:50px;border-top-right-radius: 50px">Edit Event</button>
	</div>
