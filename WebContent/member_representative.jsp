...
<%@page import="com.organissembly.dao.MemberDao,com.organissembly.bean.Member,java.util.*"%>
<%
...
<c:forEach items="${list}" var="u">
	<table style="width:100%;background:#FED250;border-radius:10px;padding-left:50px">
		<tr>
			<td style="width:20%;padding-left:50px"><p style="color:black;font-size: 18px"><strong>Student Number:</strong> ${u.getNumber()}</p></td>
			<td style="width:35%"><p style="color:black;font-size: 18px"><strong>Name:</strong> ${u.getFirstName()} ${u.getMiddleName()} ${u.getLastName()}</p></td>
				<td style="width:10%"><p style="color:black;font-size: 18px"><strong>Level:</strong> ${u.getUserLevel()}</p></td>
			<td style="width:10%"><p style="color:black;font-size: 18px"><strong>Year:</strong> ${u.getYear()}</p></td>
			<td style="width:10%"><p style="color:black;font-size: 18px"><strong>Section:</strong> ${u.getSection()}</p></td>
			<td style="width:15%"><p style="color:black;font-size: 18px"><strong>Date Applied:</strong> ${u.getDateJoined()}</p></td>
		</tr>
	</table>
</c:forEach>
</div>
