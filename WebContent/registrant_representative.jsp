...
<div id="id05" class="modal">
  <form class="modal-content animate" action="${pageContext.request.contextPath}/update_attendee" method="post">
    <div class="imgcontainer">
    ...
    <div class="container">
      ...
      <input type="text" name="editTitle" id="editTitle" disabled="disabled">

      <label for="editParticipant"><b>Event Participant Name</b></label>
      <input type="text" name="editParticipant" id="editParticipant" disabled="disabled">
	  
	  <br><br><label for="editIsPresent"><b>Is Participant Present?: </b></label>
	  <br><select name="editIsPresent" id="editIsPresent" style="width:100px" required>
		<option value="Yes">Yes</option>
		<option value="No">No</option>
	  </select>
	  
	  <input type="hidden" name="registrantId" id="registrantId"/>
      <input type="hidden" name="dateCreated" id="dateC"/>
      <button type="submit" onclick="setValues()">Update Attendance</button>
...
<div class="navbar">
  ...
  <a href="${pageContext.request.contextPath}/participants" class="active">Participants</a>
...
list = (List<Registrant>) session.getAttribute("list");
%>

<div style="width:flex;padding: 0px">
<div class="centeredDiv">
	<form action="${pageContext.request.contextPath}/update_all" method="post">
		<button type="submit" onclick="setValues()" style="font-size:30px">Set All Participation to Yes</button>
	</form>
</div>
...
<c:forEach items="${list}" var="u">
	<table style="width:100%;background:#FED250;border-radius:10px;padding-left:50px">
		<tr>
			<td style="width:30%;padding-left:50px"><p style="color:black;font-size: 18px"><strong>Event Name:</strong> ${u.getRegistrantEventName()}</p></td>
			<td style="width:15%"><p style="color:black;font-size: 18px"><strong>Student Number:</strong> ${u.getNumber()}</p></td>
			<td style="width:15%"><p style="color:black;font-size: 18px"><strong>Name:</strong> ${u.getFirstName()} ${u.getMiddleName()} ${u.getLastName()}</p></td>
			<td style="width:10%"><p style="color:black;font-size: 18px"><strong>Year:</strong> ${u.getYear()}</p></td>
			<td style="width:5%"><p style="color:black;font-size: 18px"><strong>Section:</strong> ${u.getSection()}</p></td>
			<td style="width:15%"><p style="color:black;font-size: 18px"><strong>Date Applied:</strong> ${u.getRegistrantDateCreated()}</p></td>
			<td>
				<button class="normalbtn" onclick="document.getElementById('editIsPresent').value='${u.getRegistrantIsPresent()}';
					document.getElementById('registrantId').value='${u.getRegistrantId()}';
					document.getElementById('editTitle').value='${u.getRegistrantEventName()}';
					document.getElementById('editParticipant').value='${u.getFirstName()} ${u.getMiddleName()} ${u.getLastName()}';
					document.getElementById('id05').style.display='block'" style="border-radius:5px">Update</button>
			</td>
		</tr>
	</table>
</c:forEach>
