...
public class UpdateSingleRegistrantServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String editRegistrantId = request.getParameter("registrantId");
		String editIsPresent = request.getParameter("editIsPresent");

		bean.setRegistrantIsPresent(editIsPresent);
		bean.setRegistrantId(editRegistrantId);

		int status = dao.updateSingle(bean);
